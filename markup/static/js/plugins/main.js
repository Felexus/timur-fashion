...
$(document).ready(function () {
	...
	//подробнее
	$('.que-ul-li1-title-button').click(function () {
		
		var li = $('.que-ul-li1-text')
		var pl = $('.pl1')
		var mi = $('.mi1')
	...
	$('.que-ul-li2-title-button').click(function () {
		
		var li = $('.que-ul-li2-text')
		var pl = $('.pl2')
		var mi = $('.mi2')
	...
	$('.que-ul-li3-title-button').click(function () {
		
		var li = $('.que-ul-li3-text')
		var pl = $('.pl3')
		var mi = $('.mi3')
        ...
        var it = $(this);
         it.validate({
			...
			submitHandler: function() {
				$.ajax({
					success: function(){
						console.log("fljkdsfjkldsewweiewioioeioew 28923893893893	");
